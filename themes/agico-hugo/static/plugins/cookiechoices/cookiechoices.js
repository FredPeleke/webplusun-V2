...
(function(window) {
  ...
  // IE8 ne supporte pas le textContent, donc se rabattre sur innerText.
  ...
  var cookieChoices = (function() {
    ...
    function _saveUserPreference() {
      // Programmer l'expiration du cookie à 1 an à partir du clic.
    ...
    function _shouldDisplayConsent() {
      // Afficher l'en-tête seulement si le cookie n'a pas été configuré.
